...
import static br.com.rafaelvieira.ms.orchestrated.orchestratorservice.core.enums.EEventSource.*;
import static br.com.rafaelvieira.ms.orchestrated.orchestratorservice.core.enums.ESagaStatus.*;
import static br.com.rafaelvieira.ms.orchestrated.orchestratorservice.core.enums.ETopics.*;
...
public final class SagaHandler {
    ...
    public static final Object[][] SAGA_HANDLER = {
            ...
            { PRODUCT_SERVICE, ROLLBACK_PENDING, PRODUCT_VALIDATION_FAIL },
